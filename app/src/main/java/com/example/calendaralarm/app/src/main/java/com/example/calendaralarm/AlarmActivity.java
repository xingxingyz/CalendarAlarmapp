...
public class AlarmActivity extends AppCompatActivity {
    ...
    private Button selectTimeButton, saveButton, cancelButton;
    ...
    private void initViews() {
        ...
        saveButton.setOnClickListener(v -> saveAlarm());Button.setOnClickListener(v -> finish());
        updateTimeText();
    }
    ...
    private void saveAlarm() {
        ...
        result.putExtra("hour", selectedHour);
